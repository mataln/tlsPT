...
base_dir="/home/mja78/work/tlsPT/data/supertree/plot_clouds_1cm"
output_base="/home/mja78/work/tlsPT/data/supertree/octrees_1cm"
sites=("widi-mly")
...
for site in "${sites[@]}"; do
  ...
  output_base="$output_base/$site/" #e.g. /home/matt/work/tlsPT/data/plot_octrees/allen-spain/octrees_2m
  ...
  find "$input_base" -mindepth 1 -type d | while read -r input_folder; do
    ...
    output_folder="$output_base/${plot_name}_2m" #e.g. /home/mja78/work/tlsPT/data/supertree/octrees_1cm/hjfo-fin/SPA01_2m
